...
function devFonts() {
  return src(`${options.paths.src.fonts}/**/*`).pipe(dest(options.paths.tmp.fonts))
}
...
function prodFonts() {
  return src(`${options.paths.dist.fonts}/**/*`).pipe(dest(options.paths.dist.fonts))
}
...
exports.default = series(
  ...
  includeHTML,
  parallel(devStyles, devFonts, devScripts, devImages), //Run All tasks in parallel
...
exports.prod = series(
  ...
  includeHTML,
  parallel(prodStyles, prodFonts, prodScripts, prodImages, prodHTML), //Run All tasks in parallel
  // prodCleanThemes,
  buildFinish
);